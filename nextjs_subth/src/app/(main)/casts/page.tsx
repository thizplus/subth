...
export const metadata: Metadata = {
  title: "นักแสดง JAV ซับไทย ทั้งหมด - SubTH",
  description: "รายชื่อนักแสดง AV ญี่ปุ่นทั้งหมด พร้อมผลงาน JAV ซับไทย ค้นหาตามชื่อได้",
  alternates: { canonical: "https://subth.com/casts" },
};
