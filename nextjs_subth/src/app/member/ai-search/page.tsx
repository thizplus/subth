...
// Video Card สำหรับ Virtual Grid - ใช้ memo ป้องกัน re-render
const VideoItem = React.memo(function VideoItem({ video }: { video: SemanticSearchResult }) {
  ...
  return (
    <Link href={`/member/videos/${video.id}`} className="block">
...
export default function AISearchPage() {
  ...
  // เก็บ query ที่ใช้ค้นหา (สำหรับ load more)
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="flex flex-col items-center text-center max-w-xl mx-auto">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="text-left">
                <h1 className="text-xl font-bold leading-tight">โหมดอัจฉริยะ</h1>
                <p className="text-sm text-muted-foreground">อยากดูแนวไหน บอกมาเลย!</p>
              </div>
            </div>
            ...
            <div className="relative w-full">
              ...
              <input
                ...
                placeholder="อยากดูแนวไหน พิมพ์มาเลย..."
      ...
      <div className="container mx-auto px-4 py-6">
        {/* Example Prompts - แสดงตอนยังไม่ได้ค้นหา */}
        {!hasSearched && !isLoading && (
          <div className="max-w-2xl mx-auto text-center py-8">
            ...
            <h2 className="text-2xl font-bold mb-2">ว่าไงพ่อหนุ่ม!</h2>
            <p className="text-muted-foreground mb-8">
              อยากดูอะไร บอกมาได้เลย<br />
              จัดให้หมด!
            </p>
            <div className="space-y-4">
              <p className="text-sm font-medium text-muted-foreground">ลองกดดูสิ:</p>
          ...
          <div className="space-y-6">
            ...
            {aiMessage && (
              <div className="max-w-2xl mx-auto space-y-2">
                ...
                {/* Keywords - แสดงนอก bubble */}
                {!isTyping && keywords.length > 0 && (
                  <div className="flex flex-wrap gap-1.5 pl-13">
                    <span className="text-xs text-muted-foreground">ค้นหาด้วย:</span>
            ...
            {results.length > 0 && (
              <p className="text-muted-foreground text-sm">
                ...
                {nextCursor && " • เลื่อนลงเพื่อดูเพิ่มเติม"}
              </p>
            )}
            ...
            {results.length > 0 ? (
              <>
                <VirtuosoGrid
                  ...
                  listClassName="grid grid-cols-1 md:grid-cols-4 gap-4"
                  itemContent={(index) => (
                ...
                {isLoadingMore ? (
                  <div className="flex flex-col items-center justify-center py-8 gap-3">
                    ...
                    <p className="text-muted-foreground text-sm">กำลังหาเพิ่มให้ครับ รอสักครู่...</p>
                  </div>
                ) : nextCursor ? (
