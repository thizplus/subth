          ...
          {keyMoments.map((moment, index) => (
            <Tooltip key={index}>
              <TooltipTrigger asChild>
                <button
                  onClick={handleMomentClick}
                  className="group inline-flex items-center gap-2 rounded-lg border bg-background px-3 py-1.5 text-xs transition-all hover:border-primary/50 hover:bg-primary/5"
                >
